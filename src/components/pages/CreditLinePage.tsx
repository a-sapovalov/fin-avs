...
export default function CreditLinePage() {
  const creditLineTerms = [
    ...
    { label: 'interest rate', value: 'from 9,5% per annum plus 6-month euribor, calculated on the drawn credit balance' },
  ...
  const processSteps = [
    ...
    'if the terms are suitable, we complete the required checks and prepare the credit line and security documents.',
