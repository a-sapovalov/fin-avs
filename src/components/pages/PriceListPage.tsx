              ...
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-b border-dark-brown-light hover:bg-white transition-colors">
                    ...
                    <td className="font-paragraph py-4 px-4 text-dark-brown">€500</td>
                  </tr>
                  <tr className="border-b border-dark-brown-light hover:bg-white transition-colors">
                    ...
                    <td className="font-paragraph py-4 px-4 text-dark-brown">€1,000</td>
                  </tr>
                  <tr className="border-b border-dark-brown-light hover:bg-white transition-colors">
                    ...
                    <td className="font-paragraph py-4 px-4 text-dark-brown">€2,000</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-b border-dark-brown-light hover:bg-white transition-colors">
                    ...
                    <td className="font-paragraph py-4 px-4 text-dark-brown">up to €10,000</td>
                    <td className="font-paragraph py-4 px-4 text-dark-brown">€0</td>
                  </tr>
                  <tr className="border-b border-dark-brown-light hover:bg-white transition-colors">
                    <td className="font-paragraph py-4 px-4 text-dark-brown">premium credit line</td>
                    <td className="font-paragraph py-4 px-4 text-dark-brown">from 7.5%</td>
                    <td className="font-paragraph py-4 px-4 text-dark-brown">up to €50,000</td>
                    <td className="font-paragraph py-4 px-4 text-dark-brown">€50</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table className="w-full">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-dark-brown-light hover:bg-white transition-colors">
                    ...
                    <td className="font-paragraph py-4 px-4 text-dark-brown">€5,000</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="font-paragraph text-dark-brown">
                    <span className="font-heading">application fee:</span> €0 (free)
                  </li>
                  <li className="font-paragraph text-dark-brown">
                    <span className="font-heading">processing fee:</span> 1-2% of loan amount
                  </li>
                  <li className="font-paragraph text-dark-brown">
                    <span className="font-heading">early repayment fee:</span> €0 (no penalty)
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-3">
                  <li className="font-paragraph text-dark-brown">
                    <span className="font-heading">late payment fee:</span> €10-25 per occurrence
                  </li>
                  <li className="font-paragraph text-dark-brown">
                    <span className="font-heading">document fee:</span> €5 per document
                  </li>
                  <li className="font-paragraph text-dark-brown">
                    <span className="font-heading">account maintenance:</span> €0 (free)
                  </li>
                </ul>
              </div>
            </div>
