            ...
            >
              <div className="relative w-full max-w-md">
                ...
                <div className="relative w-80 h-80 rounded-full bg-gradient-to-br from-vibrant-yellow-light to-accent-beige overflow-hidden flex items-center justify-center">
                  <Image 
                    src="https://static.wixstatic.com/media/43558d_7227215d79864394a20b12664e01322c~mv2.png?originWidth=320&originHeight=320"
                    alt="Professional person meditating with financial wellness"
                    width={320}
                    height={320}
